<script>
  ...
  async function register_user() {
    await medusa.customers.create(form).then(({ customer }) => {
  ...
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    ...
    >
      ...
      <div class="hidden lg:relative lg:block lg:p-12">
        ...
        <h2
          class="mt-6 text-2xl font-extrabold text-white sm:text-3xl md:text-4xl"
        >
          Register Now!
        </h2>
    ...
    >
      <div class="max-w-xl lg:max-w-3xl">
        <div class="relative -mt-16 block lg:hidden">
          ...
          <h1
            class="mt-2 text-2xl font-extrabold text-white sm:text-3xl md:text-4xl"
          >
            Welcome to Squid 🦑
          </h1>
        ...
        <form
          on:submit|preventDefault={register_user}
        ...
        >
          ...
          <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p class="mt-4 text-sm text-gray-400 sm:mt-0">
              ...
              <a href="/auth/login" class="text-gray-300 underline">Log in</a>.
            </p>
          </div>
        </form>
      </div>
